...
public class TopPanel extends JPanel {
    ...
    private void createExitGameButton() {
        ...
        exitGameButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                // When the 'x' button is clicked, the game will be killed and return back to
                // the start screen
    ...
    // Getter method to retrieve the middle panel, the middle panel will be where we
    // are updating the player cards and the player label every time it is changed
    // to the next player
