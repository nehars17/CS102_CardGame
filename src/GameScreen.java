...
public class GameScreen extends JFrame {
    ...
    public GameScreen(GameControl game) {
        ...
        leftPanel = new SidePanel(270, game);
        rightPanel = new SidePanel(90, game); // rotate 90 degrees
    ...
    //     int curPlayerID = game.getCurPlayerID();

    //     eastHand.setPlayerNo(curPlayerID - 1 == 0 ? 4:  curPlayerID - 1 );
    //     westHand.setPlayerNo(curPlayerID % 4 + 1);
